...
load('LFP_eyemovements')

% subtract baselines
LFP_std = LFP_eyemovements.std - LFP_eyemovements.std_baseline;
LFP_dev = LFP_eyemovements.dev - LFP_eyemovements.dev_baseline;
LFP_mov = LFP_eyemovements.mov - LFP_eyemovements.mov_baseline;
